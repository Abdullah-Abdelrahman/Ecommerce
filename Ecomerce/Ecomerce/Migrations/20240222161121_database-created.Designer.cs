...
namespace Ecomerce.Migrations
{
    ...
    [Migration("20240222161121_database-created")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoriyProduct", b =>
                {
                    b.Property<int>("Product_CategoriysCategoriy_Id")
                        .HasColumnType("int");

                    b.Property<int>("ProductsProduct_Id")
                        .HasColumnType("int");

                    b.HasKey("Product_CategoriysCategoriy_Id", "ProductsProduct_Id");

                    b.HasIndex("ProductsProduct_Id");

                    b.ToTable("CategoriyProduct");
                });
            ...
            modelBuilder.Entity("ProductSize", b =>
                {
                    b.Property<int>("Product_sizesSizeID")
                        .HasColumnType("int");

                    b.Property<int>("ProductsProduct_Id")
                        .HasColumnType("int");

                    b.HasKey("Product_sizesSizeID", "ProductsProduct_Id");
            ...
            modelBuilder.Entity("CategoriyProduct", b =>
                {
                    b.HasOne("Ecomerce.Models.Categoriy", null)
                        .WithMany()
                        .HasForeignKey("Product_CategoriysCategoriy_Id")
            ...
            modelBuilder.Entity("ProductSize", b =>
                {
                    b.HasOne("Ecomerce.Models.Size", null)
                        .WithMany()
                        .HasForeignKey("Product_sizesSizeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
