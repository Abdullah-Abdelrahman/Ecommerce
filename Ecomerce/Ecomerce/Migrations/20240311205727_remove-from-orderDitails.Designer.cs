...
namespace Ecomerce.Migrations
{
    ...
    [Migration("20240311205727_remove-from-orderDitails")]
    partial class removefromorderDitails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecomerce.Models.Order", b =>
                {
                    b.HasOne("Ecomerce.Models.Customer", "Customer")
                        .WithOne("Order")
                        .HasForeignKey("Ecomerce.Models.Order", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
